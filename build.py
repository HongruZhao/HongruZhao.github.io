...
about = f'''<section class="about-top"><div class="about-copy"><header class="about-heading"><h1>Hongru Zhao</h1><p class="role">IRSA Faragher Distinguished Postdoctoral Fellow</p><p class="affiliation">School of Statistics, University of Minnesota–Twin Cities</p></header><section class="about-bio" aria-labelledby="about-me"><h2 id="about-me">About Me</h2><p>I am a postdoctoral fellow in the <a href="https://cla.umn.edu/statistics">School of Statistics</a> at the University of Minnesota–Twin Cities (2025–2027). I received my Ph.D. in Statistics from the University of Minnesota in 2025, advised by <a href="https://users.stat.umn.edu/~arothman/">Adam J. Rothman</a>.</p><p>My current research focuses on <a href="https://hongruzhao.github.io/research/topics/#quantum-information-science">quantum information science</a>, particularly <a href="https://hongruzhao.github.io/research/topics/#quantum-tomography">quantum state estimation</a> and the foundations of <a href="https://hongruzhao.github.io/research/topics/#gaussian-boson-sampling">quantum computational advantage</a>. I also work on <a href="https://hongruzhao.github.io/research/topics/#astrostatistics">astrostatistics</a>, including modeling and inference for the stochastic gravitational-wave background. I study the <a href="https://hongruzhao.github.io/research/topics/#generative-ai-and-reinforcement-learning">theoretical foundations of machine learning</a>, including training dynamics and generative modeling with human feedback. My research also spans <a href="https://hongruzhao.github.io/research/topics/#high-dimensional-statistics">high-dimensional statistical learning and optimization</a>, <a href="https://hongruzhao.github.io/research/topics/#statistical-inference-and-experimental-design">adaptive experimental design</a>, and <a href="https://hongruzhao.github.io/research/topics/#random-matrix-theory">random matrix theory</a>.</p></section></div><aside class="profile"><img src="./assets/profile.png" alt="Hongru Zhao" width="634" height="788"><div class="profile-caption"><strong>School of Statistics</strong><span>University of Minnesota–Twin Cities</span><span>355 Ford Hall · Minneapolis, MN</span><a href="mailto:{DATA['email']}">{DATA['email']}</a><a href="https://scholar.google.com/citations?user=Gu0Z3BkAAAAJ">Google Scholar</a></div></aside></section>
