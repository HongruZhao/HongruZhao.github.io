...
about = f'''<section class="about-top"><div class="about-copy"><header class="about-heading"><h1>Hongru Zhao</h1><p class="role">IRSA Faragher Distinguished Postdoctoral Fellow</p><p class="affiliation">School of Statistics, University of Minnesota–Twin Cities</p></header><section class="about-bio" aria-labelledby="about-me"><h2 id="about-me">About Me</h2><p>I am a postdoctoral fellow in the <a href="https://cla.umn.edu/statistics">School of Statistics</a> at the University of Minnesota–Twin Cities (2025–2027). I received my Ph.D. in Statistics from the University of Minnesota in 2025, advised by <a href="https://users.stat.umn.edu/~arothman/">Adam J. Rothman</a>.</p><p>My current research focuses on <a href="./research/topics/#quantum-information-science">quantum information science</a>. I study the statistical limits of <a href="./research/topics/#quantum-tomography">quantum state estimation</a>, the behavior of <a href="./research/topics/#quantum-information-theory">quantum entanglement</a>, and the mathematical foundations of <a href="./research/topics/#gaussian-boson-sampling">quantum computational advantage</a>. My broader research interests include <a href="./research/topics/#high-dimensional-statistics">high-dimensional statistics</a>, <a href="./research/topics/#statistical-inference-and-experimental-design">adaptive experimental design</a>, and <a href="./research/topics/#astrostatistics">gravitational-wave inference</a>. <a href="./research/topics/#random-matrix-theory">Random matrix theory and probability</a> provide central mathematical tools for this work, alongside <a href="./research/topics/#generative-ai-and-reinforcement-learning">statistical learning and optimization</a>.</p></section></div><aside class="profile"><img src="./assets/profile.png" alt="Hongru Zhao" width="634" height="788"><div class="profile-caption"><strong>School of Statistics</strong><span>University of Minnesota–Twin Cities</span><span>355 Ford Hall · Minneapolis, MN</span><a href="mailto:{DATA['email']}">{DATA['email']}</a><a href="https://scholar.google.com/citations?user=Gu0Z3BkAAAAJ">Google Scholar</a></div></aside></section>
