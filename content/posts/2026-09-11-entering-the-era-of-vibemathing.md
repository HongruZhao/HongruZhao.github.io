...
**Time and cost.** Anthropic's account does not give an exact start-to-finish duration. The direct computation used about **96 CPUs for one week**, costing roughly **USD 100** in computing. Including Claude usage, von Hippel estimates **USD 1,000–2,000 per route**. ([Anthropic's account](https://www.anthropic.com/research/yes-claude-can-do-nine-loops).)
