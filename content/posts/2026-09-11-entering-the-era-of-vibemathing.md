...
Fauzan's [September 2026 preprint](https://zenodo.org/records/22826419) claims that $\zeta(5)$ is irrational. Two public Lean 4 projects—[domino14/zeta5](https://github.com/domino14/zeta5) and [mo271/Zeta5](https://github.com/mo271/Zeta5)—report completed formal proofs of that result using Mathlib's Riemann zeta function. Their reported axiom checks list only Lean's standard axioms. The repositories make the theorem statements and proof dependencies available for independent inspection.
